...
- [AIR Blackbox](https://github.com/airblackbox/gateway): Open-source EU AI Act compliance scanner and runtime trust layer for Python AI agents. HMAC-SHA256 tamper-evident audit chains, PII detection, prompt injection blocking, and risk classification. Trust layers for LangChain, CrewAI, AutoGen, OpenAI, Google ADK, and Claude Agent SDK. ![GitHub Repo stars](https://img.shields.io/github/stars/airblackbox/gateway?style=social)
- [Clawford University](https://clawford.university) ([GitHub](https://github.com/sjhddh/clawford)): Behavioral certification authority for AI agents. Verifies agents through deterministic execution trace evaluation — not benchmarks or self-reports. Certified agents receive verifiable transcripts tied to their agent ID, creating trust boundaries in multi-agent pipelines. Tier 1 (professor-curated sandboxes), Tier 2 (auto-generated exams across 3,000+ ClawHub skills), Tier 3 (unverified).
